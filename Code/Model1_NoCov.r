...
# Define the structure for the chain and the starting point
...
# Calculate the ratio using the function "logaritmo" evaluated in proposed beta0 (beta0_p) and current beta0 (beta0_p)
